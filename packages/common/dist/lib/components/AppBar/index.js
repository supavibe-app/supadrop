...
const AppBar = (props) => {
    ...
    const TopBar = (react_1.default.createElement("div", { className: "App-Bar-right" },
        ...
        react_1.default.createElement(antd_1.Popover, { placement: "topRight", title: labels_1.LABELS.SETTINGS_TOOLTIP, content: react_1.default.createElement(Settings_1.Settings, null), trigger: "click" },
