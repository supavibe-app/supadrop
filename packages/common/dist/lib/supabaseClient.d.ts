...
export declare const supabaseAddNewNFT: (id: string, img_nft?: string | undefined, name?: string | undefined, description?: string | undefined, attribute?: Attribute[] | undefined, royalty?: number | undefined, arweave_link?: string | undefined, mint_key?: string | undefined, creator?: string | undefined, mediaType?: string | undefined) => void;
...
export declare const supabaseUpdateOnSaleNFT: (idNFT?: string | undefined, onSale?: boolean | undefined) => void;
export declare const supabaseUpdateLastSoldNFT: (idNFT?: string | undefined, bid?: number | undefined) => void;
