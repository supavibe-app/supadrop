...
export declare const supabaseAddNewNFT: (id: string, img_nft: string, name: string, description: string, attribute: Attribute[], royalty: number, arweave_link: string, mint_key: string) => void;
